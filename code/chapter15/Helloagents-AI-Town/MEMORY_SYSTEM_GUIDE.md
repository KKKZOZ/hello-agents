...
赛博小镇的 NPC 现在拥有了**记忆系统**，能够记住与玩家的对话历史，并在后续对话中引用之前的内容，让 NPC 更加智能和真实！
...
**解决方法：**
- 检查日志中是否有"记忆系统已初始化"
- 检查 memory_data 目录是否存在
- 调高 forgetting_threshold 参数
...
**解决方法：**
- 降低 episodic_memory_capacity
- 提高 forgetting_threshold
- 定期清理旧记忆
...
1. ✅ **好感度系统** - NPC 与玩家的关系管理
2. ✅ **情感分析** - 使用 LLM 分析对话情感
